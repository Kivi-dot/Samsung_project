...
public class Fighter {
    ...
    public Fighter(double x, double y, double velocityX, double velocityY,  Rect initialFrame, Bitmap bitmap) {
        this.x = x;
        this.y = y;
        this.velocityX = velocityX;
        this.velocityY = velocityY; // Установите отрицательное значение для движения вверх
        this.bitmap = bitmap;
    ...
    public boolean intersect (Fighter s) {
